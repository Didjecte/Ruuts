    ...
    >
      ...
      <div class="reveal-item">
        ...
        <div class="flex flex-col gap-6 mb-12">
          <div class="flex flex-col gap-1 border-b border-secondary/20 pb-4">
            <span
              class="font-body text-xs font-medium uppercase tracking-[0.1em] text-secondary"
              >Email</span
            >
            <a
        ...
        <div class="flex flex-col md:flex-row gap-6 md:gap-8">
          ...
          >
            ...
            >
              ...
              >
                <path
                  d="M3 9V3h6v6H3zm0 12v-6h6v6H3zm12 0v-6h6v6h-6zm0-12V3h6v6h-6zm-4 4h2v2h-2v-2zm0 4h2v2h-2v-2zm-4-8h2v2H7V5zm0 12h2v2H7v-2zm8-12h2v2h-2V5zm0 8h2v2h-2v-2z"
                />
              </svg>
      ...
      <!-- Contact Form -->
      <div
        class="bg-primary/[0.03] border border-secondary/20 rounded-2xl p-6 sm:p-12 reveal-item"
      >
