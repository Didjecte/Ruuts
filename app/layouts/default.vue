<template>
  <div class="flex flex-col min-h-screen">
    ...
    <footer class="bg-dark text-light pt-16 pb-8 border-t border-secondary">
      <div
      ...
      >
        <div>
          ...
          <p class="text-sm text-light/90 max-w-[380px]">
        ...
        <div>
          ...
          <ul class="list-none">
            <li class="mb-[0.6rem]">
              <NuxtLink
                to="/"
                class="text-sm text-light/75 transition-all duration-200 hover:text-primary hover:pl-1 block w-fit"
        ...
        <div>
          ...
          <p class="text-sm text-light/75 mb-2">contact@theruuts.com</p>
          <p class="text-sm text-light/75 mb-2">+86 18217180655</p>
        </div>
      </div>
      <div class="border-t border-light/10 pt-8">
        <div
          class="max-w-[1200px] mx-auto px-6 w-full flex flex-col md:flex-row justify-between items-center text-xs text-light/50 gap-4 md:gap-0 text-center md:text-left"
        >
          <p>
